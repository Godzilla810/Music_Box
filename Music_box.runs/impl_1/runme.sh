...
HD_PWD='C:/Users/HMG/Desktop/Github/01_Music_Box/Music_box.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log song.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source song.tcl -notrace
