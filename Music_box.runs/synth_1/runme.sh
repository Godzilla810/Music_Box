...
HD_PWD='C:/Users/HMG/Desktop/Github/01_Music_Box/Music_box.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log song.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source song.tcl
